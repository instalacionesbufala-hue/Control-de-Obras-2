...
const STEPS = [
  ...
  { title: '2. Materiales, conceptos y kits', subtitle: 'Precios de venta con coste interno oculto', icon: Zap, color: 'bg-amber-500', tab: 'kits',
  ...
  { title: '3. Presupuesto → aceptación → obra', subtitle: 'El cliente acepta desde su móvil', icon: FileCheck2, color: 'bg-emerald-500', tab: 'obras',
